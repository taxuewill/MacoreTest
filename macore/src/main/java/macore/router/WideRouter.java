...
public class WideRouter {
    ...
    public static final String PROCESS_NAME = "com.macore";
    ...
    public static void registerRemoteRouter(String processName, String pkgName, String clsName) {
        if (null == sLocalRouterClasses) {
            sLocalRouterClasses = new HashMap<>();
        }
        ConnectServiceWrapper connectServiceWrapper = new ConnectServiceWrapper(pkgName, clsName);
        sLocalRouterClasses.put(processName, connectServiceWrapper);
    }
    ...
    boolean checkLocalRouterHasRegistered(final String domain) {
        ...
        String pkgName = connectServiceWrapper.pkgName;
        String clsName = connectServiceWrapper.clsName;
        if (null == clazz && (null == pkgName || null == clsName)) {
            return false;
        } else {
            return true;
        }
    ...
    boolean connectLocalRouter(final String domain) {
        ...
        Intent binderIntent = null;
        if(clazz == null){
            binderIntent = new Intent();
            binderIntent.setClassName(pkgName, clsName);
        }else {
            binderIntent = new Intent(mApplication, clazz);
        }
