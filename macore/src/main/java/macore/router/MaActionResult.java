...
public class MaActionResult<T> implements Parcelable {
    ...
    public static final class Builder<T> {
        ...
        public final MaActionResult ErrorResult(){
            return code(MaActionResult.CODE_ERROR).msg("error").build();
        }

        public final MaActionResult SuccessResult(){
            return code(MaActionResult.CODE_SUCCESS).msg("success").build();
        }
